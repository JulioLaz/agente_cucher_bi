...
CATEGORIAS = {
    ...
    "mascotas":    {"familia":None,"subfamilia":"Alimentos para mascot",
                    "sinonimos":["mascota","mascotas","perro","perros","gato","gatos",
                                 ...
                                 "alimentos para mascota","alimentos para mascotas",
                                 "alimento para gato","alimentos para gato",
                                 "comida para perro","comida para gato",
                                 "veterinaria","balanceado","alimento balanceado",
                                 "accesorios para mascotas","comida mascota"],
